...
-   Please go to the [course website](https://bsmm-8740-fall-2023.github.io/osb/) to review the content, access the labs, read the syllabus, etc.
-   I will also post the weekly slides on [Brightspace](https://brightspace.uwindsor.ca/d2l/home/144921).
-   My intent is to have assigned lab exercises each week, which should be able to be completed during class.
    -   If we run over or if you'd like more time, the lab assignment will remain on the course Github site and your work will remain on your own Github account can can be submitted by the deadline.
