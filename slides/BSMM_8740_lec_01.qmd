---
title: "Data Analytic Methods & Algorithms"
...
-   Lab 1 is due Friday September 15, at 5pm, on [Brightspace](https://brightspace.uwindsor.ca/d2l/home/144921).
...
tibble::tibble(
  week = 1:11
  , topic = 
    c('Tidyverse', 'EDA & feature engineering', 'Recipes', 'Regression', 'Tidymodels'
      , 'Classification', 'Time Series', 'Causality', 'Causality', 'Bayesian methods', 'Bayesian methods')
) %>% 
  gt::gt() %>% 
...
The `summarize` verb is usually used with `group_by`
...
When used alone, `summarize()` collapses a data frame into a single row.
