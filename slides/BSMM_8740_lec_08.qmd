---
title: "Causality"
subtitle: "BSMM8740-2-R-2023F [WEEK - 8]"
author: "L.L. Odette"
...
-   **description**: EDA, KPIs, distributions

    -   (validity issues: measurement & sampling)

-   **prediction**: accuracy, generalizing to new data, train-test splits

    -   (validity issues: rmse, AUC, we know if we are right)

-   **causal inference** (impact)

    -   (validity: assumptions, no correctness, predictability)
