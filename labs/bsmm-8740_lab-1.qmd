...
-   Go to the course organization at [github.com/BSMM-8740-Fall-2023](https://github.com/BSMM-8740-Fall-2023/osb "Course GitHub organization") organization on GitHub. Click on the repo with the prefix **lab-1**. It contains the starter documents you need to complete the lab.
