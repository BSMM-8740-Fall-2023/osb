...
```{r, message = FALSE}
#| eval: false
the_tate <- readr::read_delim("labs/data/the-tate-collection.csv", ";", escape_double = FALSE, trim_ws = TRUE)
...
```{r}
#| eval: false
spx_data <- readr::read_csv("labs/data/SPX_HistoricalData_1692322132002.csv", show_col_types = FALSE)
