...
[Click here](/documents/BSMM-8740-Fall 2023.pdf "PDF of syllabus") **to download a PDF copy of the syllabus.**

## Course info

|           | Day    | Time              | Location                       |
|-----------|--------|-------------------|--------------------------------|
| Lectures  | Monday | 1:00 pm - 4:00 pm | Reuben-Cooke Building 130      |
