...
"Telephone"	                    ,"+1 617-935-0016" 	  ,"Email"	,"lodette@uwindsor.ca", 
...
|-----------------|---------------------|
| Jun 9, 2023     | Lab Assessment 1    |
| Jun 16, 2023    | Quiz1               |
| Jun 27, 2023    | Midterm Examination |
| Jul 16, 2023    | Lab Assessment 2    |
| Jul 25, 2023    | Quiz 2              |
| Aug 1, 2023     | Lab Assessment 3    |
| Aug 12-21, 2023 | Final Examination   |
...
Lab assessments will require learners to demonstrate the ability to apply methods and techniques to machine learning problem using the R language and explain the steps they followed to solve a problem.  Assessments must be completed in person during lab sessions.
