...
## How do I export my assignment PDF from RStudio to upload to Brightspace?
...
The instructions for submitting your assignment to Brightspace can be found [here](https://help.gradescope.com/article/ccbpppziu9-student-submit-work#submitting_a_pdf). In a nutshell, you'll upload your HTML and then mark the page(s) where each question can be found. It's OK if a question spans multiple pages, just mark them all. It's also OK if a page includes multiple questions.
